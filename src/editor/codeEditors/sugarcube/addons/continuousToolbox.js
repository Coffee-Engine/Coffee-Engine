(function () {
  ...
  sugarcube.ContinuousFlyout = ContinuousFlyout;
  sugarcube.ContinuousMetrics = ContinuousMetrics;
  sugarcube.ContinuousFlyoutMetrics = ContinuousFlyoutMetrics;
  sugarcube.ContinuousToolbox = ContinuousToolbox;
})();
