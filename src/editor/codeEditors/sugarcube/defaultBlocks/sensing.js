(function () {
    ...
    <g transform="translate(-100.23211,-9.57927)">
        <g data-paper-data="{&quot;isPaintingLayer&quot;:true}" fill-rule="nonzero" stroke="#000000"
            ...
            <path style="cursor:pointer;"
                ...
                fill="#ffffff" stroke-width="3" stroke-linecap="butt" />
            <path style="cursor:pointer;"
            ...
            <path style="cursor:pointer;"
                ...
                fill="#ffffff" stroke-width="3" stroke-linecap="butt" />
            <path style="cursor:pointer;" d="M196.79981,248.25108v-14.99579h13.26049v14.99579l-6.31452,6.66479z" fill="#ffffff" stroke-width="3"
                stroke-linecap="butt" />
            <path style="cursor:pointer;" d="M203.74578,254.91587l6.31453,6.66479v14.99579h-13.2605v-14.99579z"
                data-paper-data="{&quot;index&quot;:null}" fill="#ffffff" stroke-width="3" stroke-linecap="butt" />
            <path style="cursor:pointer;" d="M196.76526,261.54612h-14.99578v-13.26049h14.99578l6.66479,6.31452z" fill="#ffffff" stroke-width="3"
                stroke-linecap="butt" />
            <path style="cursor:pointer;" d="M203.43006,254.60015l6.66479,-6.31452h14.99579v13.26049h-14.99579z"
                data-paper-data="{&quot;index&quot;:null}" fill="#ffffff" stroke-width="3" stroke-linecap="butt" />
            <path style="cursor:pointer;"
                ...
                fill="#ffffff" stroke-width="3" stroke-linecap="round" />
            <path style="cursor:pointer;"
                ...
                data-paper-data="{&quot;index&quot;:null}" fill="#ffffff" stroke-width="3" stroke-linecap="round" />
            <path
