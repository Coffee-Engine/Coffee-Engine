...
!(function (e, t) {
    ...
    const i = { codeRemoveIndent: /^(?: {1,4}| {0,3}\t)/gm, outputLinkReplace: /\\([\[\]])/g, indentCodeCompensation: /^(\s+)(?:```)/, beginningSpace: /^\s+/, endingHash: /#$/, startingSpaceChar: /^ /, endingSpaceChar: / $/, nonSpaceChar: /[^ ]/, newLineCharGlobal: /\n/g, tabCharGlobal: /\t/g, multipleSpaceGlobal: /\s+/g, blankLine: /^[ \t]*$/, doubleBlankLine: /\n[ \t]*\n[ \t]*$/, blockquoteStart: /^ {0,3}>/, blockquoteSetextReplace: /\n {0,3}((?:=+|-+) *)(?=\n|$)/g, blockquoteSetextReplace2: /^ {0,3}>[ \t]?/gm, listReplaceTabs: /^\t+/, listReplaceNesting: /^ {1,4}(?=( {4})*[^ ])/g, listIsTask: /^\[[ xX]\] /, listReplaceTask: /^\[[ xX]\] +/, anyLine: /\n.*\n/, hrefBrackets: /^<(.*)>$/, tableDelimiter: /[:|]/, tableAlignChars: /^\||\| *$/g, tableRowBlankLine: /\n[ \t]*$/, tableAlignRight: /^ *-+: *$/, tableAlignCenter: /^ *:-+: *$/, tableAlignLeft: /^ *:-+ *$/, startATag: /^<a /i, endATag: /^<\/a>/i, startPreScriptTag: /^<(pre|code|kbd|script)(\s|>)/i, endPreScriptTag: /^<\/(pre|code|kbd|script)(\s|>)/i, startAngleBracket: /^</, endAngleBracket: />$/, pedanticHrefTitle: /^([^'"]*[^\s])\s+(['"])(.*)\2/, unicodeAlphaNumeric: /[\p{L}\p{N}]/u, escapeTest: /[&<>"']/, escapeReplace: /[&<>"']/g, escapeTestNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/, escapeReplaceNoEncode: /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g, unescapeTest: /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi, caret: /(^|[^\[])\^/g, percentDecode: /%25/g, findPipe: /\|/g, splitPipe: / \|/, slashPipe: /\\\|/g, carriageReturn: /\r\n|\r/g, spaceLine: /^ +$/gm, notSpaceStart: /^\S*/, endingNewline: /\n$/, listItemRegex: (e) => new RegExp(`^( {0,3}${e})((?:[\t ][^\\n]*)?(?:\\n|$))`), nextBulletRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ \t][^\\n]*)?(?:\\n|$))`), hrRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), fencesBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}(?:\`\`\`|~~~)`), headingBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}#`), htmlBeginRegex: (e) => new RegExp(`^ {0,${Math.min(3, e - 1)}}<(?:[a-z].*>|!--)`, "i") },
        ...
        m = { ...x, table: b, paragraph: r(c).replace("hr", l).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", b).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", g).getRegex() },
        ...
        I = r(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
            ...
            .getRegex(),
        L = r(k).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
        B = r("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>")
            .replace("comment", L)
        ...
        P = r(/^!?\[(ref)\](?:\[\])?/)
            .replace("ref", h)
            .getRegex(),
        Z = { _backpedal: s, anyPunctuation: _, autolink: I, blockSkip: /\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g, br: $, code: /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, del: s, emStrongLDelim: z, emStrongRDelimAst: A, emStrongRDelimUnd: S, escape: y, link: E, nolink: P, punctuation: T, reflink: q, reflinkSearch: r("reflink|nolink(?!\\()", "g").replace("reflink", q).replace("nolink", P).getRegex(), tag: B, text: /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, url: s },
        v = {
            ...Z,
            link: r(/^!?\[(label)\]\((.*?)\)/)
                .replace("label", C)
        ...
        M = { normal: x, gfm: m, pedantic: w },
        O = { normal: Z, gfm: Q, breaks: D, pedantic: v },
        j = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
        N = (e) => j[e];
    function G(e, t) {
        if (t) {
    ...
    class J {
        ...
        code(e) {
            ...
            if (t) {
                ...
                return { type: "code", raw: t[0], codeBlockStyle: "indented", text: this.options.pedantic ? e : F(e, "\n") };
            }
        }
        fences(e) {
        ...
        list(e) {
            ...
            if (t) {
                ...
                for (; e; ) {
                    ...
                    let u,
                        g = null;
                    this.options.gfm && ((g = this.rules.other.listIsTask.exec(o)), g && ((u = "[ ] " !== g[0]), (o = o.replace(this.rules.other.listReplaceTask, "")))), r.items.push({ type: "list_item", raw: s, task: !!g, checked: u, loose: !1, text: o, tokens: [] }), (r.raw += s);
                }
        ...
        table(e) {
            ...
            const n = X(t[1]),
                ...
                r = t[3] && t[3].trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split("\n") : [],
            ...
            if (n.length === s.length) {
                ...
                for (const e of r) i.rows.push(X(e, i.header.length).map((e, t) => ({ text: e, tokens: this.lexer.inline(e), header: !1, align: i.align[t] })));
                return i;
            }
        }
        lheading(e) {
        ...
        link(e) {
            ...
            if (t) {
                ...
                return (n = n.trim()), this.rules.other.startAngleBracket.test(n) && (n = this.options.pedantic && !this.rules.other.endAngleBracket.test(e) ? n.slice(1) : n.slice(1, -1)), U(t, { href: n ? n.replace(this.rules.inline.anyPunctuation, "$1") : n, title: s ? s.replace(this.rules.inline.anyPunctuation, "$1") : s }, t[0], this.lexer, this.rules);
            }
        }
        reflink(e, t) {
            let n;
    ...
    class K {
        ...
        inlineQueue;
        constructor(t) {
            (this.tokens = []), (this.tokens.links = Object.create(null)), (this.options = t || e.defaults), (this.options.tokenizer = this.options.tokenizer || new J()), (this.tokenizer = this.options.tokenizer), (this.tokenizer.options = this.options), (this.tokenizer.lexer = this), (this.inlineQueue = []), (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
            const n = { other: i, block: M.normal, inline: O.normal };
            this.options.pedantic ? ((n.block = M.pedantic), (n.inline = O.pedantic)) : this.options.gfm && ((n.block = M.gfm), this.options.breaks ? (n.inline = O.breaks) : (n.inline = O.gfm)), (this.tokenizer.rules = n);
        }
        static get rules() {
            return { block: M, inline: O };
        }
        static lex(e, t) {
        ...
        blockTokens(e, t = [], n = !1) {
            ...
            for (this.options.pedantic && (e = e.replace(i.tabCharGlobal, "    ").replace(i.spaceLine, "")); e; )
                if (!(this.options.extensions && this.options.extensions.block && this.options.extensions.block.some((n) => !!(s = n.call({ lexer: this }, e, t)) && ((e = e.substring(s.raw.length)), t.push(s), !0))))
                    if ((s = this.tokenizer.space(e))) (e = e.substring(s.raw.length)), 1 === s.raw.length && t.length > 0 ? (t[t.length - 1].raw += "\n") : t.push(s);
                    ...
                    else if ((s = this.tokenizer.def(e))) (e = e.substring(s.raw.length)), (r = t[t.length - 1]), !r || ("paragraph" !== r.type && "text" !== r.type) ? this.tokens.links[s.tag] || (this.tokens.links[s.tag] = { href: s.href, title: s.title }) : ((r.raw += "\n" + s.raw), (r.text += "\n" + s.raw), (this.inlineQueue[this.inlineQueue.length - 1].src = r.text));
                        ...
                        if (this.state.top && (s = this.tokenizer.paragraph(l))) (r = t[t.length - 1]), n && "paragraph" === r?.type ? ((r.raw += "\n" + s.raw), (r.text += "\n" + s.text), this.inlineQueue.pop(), (this.inlineQueue[this.inlineQueue.length - 1].src = r.text)) : t.push(s), (n = l.length !== e.length), (e = e.substring(s.raw.length));
        ...
        inlineTokens(e, t = []) {
            ...
            for (; e; )
                if ((l || (o = ""), (l = !1), !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some((s) => !!(n = s.call({ lexer: this }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0)))))
                    ...
                    else if ((n = this.tokenizer.tag(e))) (e = e.substring(n.raw.length)), (s = t[t.length - 1]), t.push(n);
    ...
    class V {
        ...
        listitem(e) {
            ...
            if (e.task) {
                ...
                e.loose ? (e.tokens.length > 0 && "paragraph" === e.tokens[0].type ? ((e.tokens[0].text = n + " " + e.tokens[0].text), e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && "text" === e.tokens[0].tokens[0].type && ((e.tokens[0].tokens[0].text = n + " " + G(e.tokens[0].tokens[0].text)), (e.tokens[0].tokens[0].escaped = !0))) : e.tokens.unshift({ type: "text", raw: n + " ", text: n + " ", escaped: !0 })) : (t += n + " ");
            }
        ...
        onError(e, t) {
            return (n) => {
                if (((n.message += "\nPlease report this to https://github.com/markedjs/marked."), e)) {
                    const e = "<p>An error occurred:</p><pre>" + G(n.message + "", !0) + "</pre>";
